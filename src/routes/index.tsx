...
const FAQ = [
  {
    q: "What is $SPCMEME?",
    a: "Space Meme is a community memecoin engineered with the discipline of a rocket program and the energy of the internet. Fair launch, no presale, no team allocation.",
  },
  {
    q: "How is the launch fair?",
    ...
    <div className="min-h-screen bg-black text-foreground overflow-x-hidden">
        ...
        <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          <a href="#top" className="flex items-center gap-2">
            <span className="font-display text-xl tracking-widest">
              SPACE<span className="text-blue">·</span>MEME
            </span>
          </a>
          <div className="hidden md:flex items-center gap-8 text-xs uppercase tracking-[0.25em] font-sans">
            ...
            <a href="#tokenomics" className="hover:text-blue transition">
              Tokenomics
            </a>
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-3 py-2 text-xs uppercase tracking-widest border border-border hover:border-blue hover:text-blue transition"
            >
              Twitter
            </a>
            <a
              href="https://t.me/spacexmeme"
              target="_blank"
              rel="noreferrer"
              className="px-3 py-2 text-xs uppercase tracking-widest border border-border hover:border-blue hover:text-blue transition"
            >
      ...
      <section id="top" className="relative min-h-screen flex flex-col justify-end">
        ...
        <div className="relative max-w-7xl mx-auto w-full px-6 pb-24 pt-40">
          ...
          <h1 className="font-display text-[14vw] md:text-[10vw] leading-[0.85] mb-6">
            SPACE
            <br />
            <span className="text-blue glow-blue">MEME</span>
          </h1>
          <p className="max-w-xl text-lg text-muted-foreground mb-8">
            The memecoin engineered for orbit. Inspired by the most ambitious rocket program on Earth — built for the
            most degenerate community in the universe.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-5xl md:text-6xl mb-8">
              ...
              <br />
              Engineered Like
              <br />A <span className="text-blue">Rocket</span>.
            </h2>
            <p className="text-muted-foreground mb-4 text-lg">
              $SPCMEME isn't another rug with a dog picture. It's a fair-launch experiment combining the precision of
              aerospace and the chaos of meme culture.
            </p>
            <p className="text-muted-foreground mb-8">
              No presale. No team tokens. No insider allocations. Liquidity locks at T-0. Mission control: the
              community.
            </p>
          ...
          <div className="relative anim-float">
            ...
            <img
              ...
              height={100}
              loading="lazy"
              className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-2/3 invert opacity-90"
            />
          </div>
        </div>
      </section>
      ...
      <section id="booster" className="relative py-32 overflow-hidden border-t border-border">
        <img
          ...
          height={1024}
          loading="lazy"
          className="absolute -right-32 top-1/2 -translate-y-1/2 w-[700px] opacity-70"
        />
      ...
      <section id="faq" className="py-32 border-t border-border">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h2 className="text-5xl md:text-7xl mb-16">
            Mission
            <br />
            Briefing.
          </h2>
...
function Spec({ k, v, highlight }: { k: string; v: string; highlight?: boolean }) {
  return (
    <div className={`p-8 ${highlight ? "bg-blue text-white" : "bg-black"}`}>
      <div
        className={`text-xs uppercase tracking-[0.3em] mb-3 font-mono ${highlight ? "text-white/70" : "text-muted-foreground"}`}
      >
        {k}
      </div>
